...
class signupNgo extends StatefulWidget {
  @override
  _signupNgoState createState() => _signupNgoState();
}
          ...
          child: ListView(
            children: <Widget>[
              ...
              Align(
                  ...
                  child: Text('Register NGO',style: Theme.of(context).textTheme.headline.copyWith(color: Colors.teal),)),
